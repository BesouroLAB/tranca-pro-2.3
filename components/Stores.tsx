...
const BRAZIL_STORES: Store[] = [
  // SÃO PAULO (O HUB)
  {
    id: 'sp1', name: 'Rei do Jumbo', address: 'R. da Cantareira, 385 (Região da 25)', city: 'São Paulo - SP', reviews: [
      { id: 'r1', author: 'Cintia Tranças', rating: 5, comment: 'Melhor preço de SP disparado. Chego cedo pra não pegar fila, mas vale muito a pena pelo Jumbo da Ser Mulher.', date: '12/10/2026' },
      { id: 'r2', author: 'Dandara Afro', rating: 4, comment: 'Muita variedade, mas o atendimento é meio corrido. Vá com paciência!', date: '05/10/2026' }
    ]
  },
  {
    id: 'sp2', name: 'Du Chapéu Hair', address: 'R. Barão de Duprat, 21', city: 'São Paulo - SP', reviews: [
      { id: 'r3', author: 'Bruna Braids', rating: 5, comment: 'O paraíso das laces e materiais orgânicos. Sempre encontro o que preciso.', date: '15/10/2026' }
    ]
  },
  {
